      ...
      <main className="bg-[#f7fbfb] px-5 py-16 sm:py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-5 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <a
              href="tel:+37062357946"
              className="inline-flex items-center gap-3 rounded-2xl border border-line bg-white px-5 py-3.5 text-base font-bold text-ink shadow-sm transition hover:-translate-y-0.5 hover:border-brand-500 hover:text-brand-700 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2"
            >
